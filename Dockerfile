...
RUN pip install autopep8 pymysql nltk pymongo google-cloud-pubsub python-dateutil pycryptodome treelib
...
RUN pip install sharepoint
RUN pip install tqdm
RUN Rscript -e 'install.packages("formatR",repos="http://lib.stat.cmu.edu/R/CRAN/")'
RUN Rscript -e 'install.packages("data.table",repos="http://lib.stat.cmu.edu/R/CRAN/")'
